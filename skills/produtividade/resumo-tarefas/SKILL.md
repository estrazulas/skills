...
```
skills/produtividade/resumo-tarefas/
├── SKILL.md
└── scripts/
    └── resumo-tarefas.py
```
...
- `~/.hermes/skills/resumo-tarefas` -> `skills/produtividade/resumo-tarefas/`
- `~/.hermes/scripts/resumo-tarefas.py` -> `skills/produtividade/resumo-tarefas/scripts/resumo-tarefas.py`
